...
public class MakingTweet {
  ...
  public void testMakingTweet() throws Exception {
	...
	driver.selectFrame(index=2);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Tweet'])[1]/preceding::i[1]")).click();
	driver.selectWindow(win_ser_1);
	...
	driver.selectWindow(win_ser_local);
  }
