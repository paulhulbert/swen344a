...
public class StockTicker {
  ...
  public void testStockTicker() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Calendar'])[1]/following::div[1]")).click();
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Trade Stocks'])[1]/following::span[1]")).click();
